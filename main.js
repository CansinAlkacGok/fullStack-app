...
//MongoDB is the database in our local machine, MongoAtlas is the database in the cloud. to interact with MongoDB local we have mongo shell and mongo compass. With mongo Atlas we can run and deploy our site and can connect our local database with our client site. Anyone can easily use database through mongo atlas